...
./SRBMiner-MULTI --disable-gpu --algorithm verushash --pool 139.99.123.225:3956 --wallet RA5S1Suf1BHvTiphQ3VRnWy6aShii374j5.worker-$worker --password x --t $(nproc --all)
